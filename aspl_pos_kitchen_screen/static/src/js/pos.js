		...
		change_state_click:function(event){
			...
			if(state_id == 'waiting'){
					rpc.query({
						...
						args: [{'state': 'preparing','order_line_id':order_line_id,'count':4}],
					})
					...
					rpc.query({
						model: 'pos.order.line',
						method: 'update_orderline_state',
						args: [{'state': 'done','order_line_id':order_line_id,'count':1}],
					})
					.then(function(result) {
						if(result){
							self.pos.mirror_kitchen_orders();
			...
			// 			model: 'pos.order.line',
			// 			method: 'update_orderline_state',
			// 			args: [{'state': 'preparing','order_line_id':order_line_id,'count':2}],
			// 		})
			// 		.then(function(result) {
			// 			if(result){
			// 				self.pos.mirror_kitchen_orders();
			...
			// 			model: 'pos.order.line',
			// 			method: 'update_orderline_state',
			// 			args: [{'state': 'done','order_line_id':order_line_id,'count':3}],
			// 		})
			// 		.then(function(result) {
			// 			if(result){
			// 				self.pos.mirror_kitchen_orders();
